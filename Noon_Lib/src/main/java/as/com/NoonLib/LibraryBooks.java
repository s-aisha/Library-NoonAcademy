...
public class LibraryBooks extends Fragment {
    ...
    private void dataSource1() {
        ...
        al.add( new Initialiser(namesStore.getBook1(),"Grade I",namesStore.getBid1(),R.drawable.c,prefs.getInt(""+namesStore.getBid1(),15)));
        ...
        al.add( new Initialiser(namesStore.getBook3(),"Grade III",namesStore.getBid3(),R.drawable.cpp,prefs.getInt(""+namesStore.getBid3(),12)));
        al.add( new Initialiser(namesStore.getBook4(),"Grade IV",namesStore.getBid4(),R.drawable.ds,prefs.getInt(""+namesStore.getBid4(),20)));
        al.add( new Initialiser(namesStore.getBook5(),"Grade V",namesStore.getBid5(),R.drawable.java,prefs.getInt(""+namesStore.getBid5(),10)));
        al.add( new Initialiser(namesStore.getBook6(),"Grade VI",namesStore.getBid6(),R.drawable.os,prefs.getInt(""+namesStore.getBid6(),15)));
    ...
    private void dataSource(View view) {
        ...
        editor1.putInt(""+namesStore.getBid1(),15);
        editor1.putInt(""+namesStore.getBid2(),10);
        editor1.putInt(""+namesStore.getBid3(),12);
        editor1.putInt(""+namesStore.getBid4(),20);
        editor1.putInt(""+namesStore.getBid5(),10);
        editor1.putInt(""+namesStore.getBid6(),15);
